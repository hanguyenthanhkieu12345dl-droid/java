...
public class JavaConnection {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost/test?useSSL=false&allowPublicKeyRetrieval=true";
    private static final String JDBC_USER = "root";
    private static final String JDBC_PASS = "27052006";
